...
# Django settings for djangowars project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'godfather.db',                      # Or path to database file if using sqlite3.
...
MEDIA_URL = 'http://localhost:8000/static/assets/itens/'
...
STATIC_URL = 'http://frenetic.com.br/djangowars'    #'/static/'
...
SECRET_KEY = 'n-@q^bk4teehf259=26bvd(c9lz(*r%hyqs*bna5d=5%r1srx!'
...
ROOT_URLCONF = 'djangowars.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'djangowars.wsgi.application'
